...
class MetricsDataActorSpec()
  ...
  private val metric = "metricsDataActorSpec"
  ...
  "metricsDataActorSpec" should "write and delete properly" in within(5.seconds) {
    ...
    val expectedAdd = awaitAssert { probe.expectMsgType[RecordAdded] }
    ...
    val expectedCount = awaitAssert { probe.expectMsgType[CountGot] }
  ...
  "metricsDataActorSpec" should "write and delete properly in multiple namespaces" in within(5.seconds) {
    ...
    awaitAssert { probe.expectMsgType[RecordAdded] }
    ...
    val expectedCount2 = awaitAssert { probe.expectMsgType[CountGot] }
    expectedCount2.metric shouldBe metric + "2"
    expectedCount2.count shouldBe 1

  }

  "metricsDataActorSpec" should "delete a namespace" in within(5.seconds) {
